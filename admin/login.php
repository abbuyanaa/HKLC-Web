	...
	<div class="content">
		...
		<form class="login-form" action="" method="post">
			...
			<div class="form-group">
				...
				<input class="form-control form-control-solid placeholder-no-fix" type="email" autocomplete="off" placeholder="Цахим хаяг" name="email" />
			</div>
			<div class="form-group">
		...
		<div class="create-account">
			<p>
				<a href="#" class="uppercase">Create an account</a>
			</p>
		</div>
	</form>
	<!-- END LOGIN FORM -->

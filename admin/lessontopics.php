									...
									<table class="table table-bordered table-hover">
										<thead>
											<tr>
												...
												<th style="text-align: center;" width="40%">Сэдэв</th>
										...
										<tbody>
											<?php
											$getData = $learn->getLessonTopics($bookid);
											if ($getData != false) { $i=1;
												while ($row = $getData->fetch_assoc()) { ?>
													<tr>
														<td align="center"><?php echo $i++; ?></td>
														<td><?php echo $row['kr_name'].' - '.$fm->ucfirst($row['mn_name']); ?></td>
														<td align="center"><?php echo $row['word_count']; ?></td>
														<td align="center">
															<a href="lessonlevel.php?bid=<?php echo $row['bid'].'&tid='.$row['tid']; ?>" class="btn btn-outline btn-circle btn-sm blue">
